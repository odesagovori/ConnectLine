...
<body>
    ...
    <div class="navbar">
        ...
        <button class="go-to-register-button" onclick="window.location.href='Register.php'">Join a Course?</button>
        <button class="sign-out-button" onclick="window.location.href='AboutUs.php'">Back to Start</button>
    </div>
